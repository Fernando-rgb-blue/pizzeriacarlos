...
export default function MenuItemTile({onAddToCart, ...item}) {
    ...
    return (
        <div className="bg-gray-200 p-4 rounded-lg text-center flex flex-col justify-between group hover:bg-white hover:shadow-md hover:shadow-black/25 transition-all">
            <div>
